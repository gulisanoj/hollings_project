...
# ----------------------------------------------------
base_dir = "/Projects/flood_threat/model_automation/2025_lsrs/"
input_file = os.path.join(base_dir, "2025_lsrs.csv")
output_file = os.path.join(base_dir, "2025_classified.csv")
